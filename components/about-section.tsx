            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-5'>
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute -inset-1 bg-linear-to-r from-cyan-400 to-blue-500 rounded-full blur opacity-30 animate-pulse z-0"></div>
                        <Image
                ...
                <div className='w-full col-span-1 md:col-span-2 flex flex-col justify-center space-y-4'>
                    ...
                    <div className='w-full flex items-start justify-start gap-2'>
                        {
                            techStack?.map((t, index) => <TooltipImage key={index} src={t?.src} name={t?.name} isBg/>)
                        }
                    </div>
                </div>
            </div>
