      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="w-full col-span-1 md:col-span-2 flex flex-col justify-center space-y-3">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            building products end to end web apps, backend systems, and
            developer tools. I care about how systems work, not just how they
            look.
          </p>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            Currently exploring system design through personal projects and open
            source. Open to full time roles{" "}
