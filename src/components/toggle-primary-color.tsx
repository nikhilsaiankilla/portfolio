...
const TogglePrimaryColor = () => {
  ...
  const setPrimaryColor = (value: string) => {
    document.documentElement.style.setProperty("--primary", `oklch(${value})`);
    ...
    <AnimatedTooltip label="Theme color">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <div className="w-5 h-5 rounded-sm cursor-pointer bg-primary border border-primary shadow-md" />
        </DropdownMenuTrigger>
